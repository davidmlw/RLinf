...
environment once at
`rlinf-workspace/envs/gr00t-newton-py312-cu128-v6/`. The committed runtime spec,
...
pins `hydra-core==1.3.2`, `numpy==1.26.0`, GR00T's
`transformers==4.51.3`, and the PyTorch 2.11-compatible CPU build
`torchcodec==0.11.1+cpu`, then installs the immutable 0.11.1 wheel and
